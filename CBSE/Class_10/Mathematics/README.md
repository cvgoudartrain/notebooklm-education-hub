# CBSE Class 10 Mathematics - NotebookLM Resources

This repository contains NotebookLM-powered AI study guides for CBSE Class 10 Mathematics curriculum. Each notebook is trained on official NCERT textbooks and exemplar problems.
...
| 07 | Coordinate Geometry | [View Guide](https://notebooklm.google.com/notebook/d4dfff34-56c4-4227-b7ab-bad682e95d1e) | [Textbook](./resources/07_coordinate_geometry/cbse_10_maths_ch07_coordinate_geometry_textbook.pdf) • [Exemplar](./resources/07_coordinate_geometry/cbse_10_maths_ch07_coordinate_geometry_exemplar.pdf) |
| 08 | Introduction to Trigonometry | [View Guide](https://notebooklm.google.com/notebook/077a1ca0-5cd7-4ec3-8a6a-0b5a58f2b669) | [Textbook](./resources/08_trigonometry/cbse_10_maths_ch08_trigonometry_textbook.pdf) • [Exemplar](./resources/08_trigonometry/cbse_10_maths_ch08_trigonometry_exemplar.pdf) |
| 09 | Some Applications of Trigonometry | [View Guide](https://notebooklm.google.com/notebook/38019881-8d83-4ed6-bb05-d8198cf0d1e1) | [Textbook](./resources/09_applications_trigonometry/cbse_10_maths_ch09_applications_trigonometry_textbook.pdf) |
| 10 | Circles | [View Guide](https://notebooklm.google.com/notebook/4fcbdb47-82c0-4dc1-9cca-5977ebe1834a) | [Textbook](./resources/10_circles/cbse_10_maths_ch10_circles_textbook.pdf) • [Exemplar](./resources/10_circles/cbse_10_maths_ch10_circles_exemplar.pdf) |
...
| **Hardest Chapters** | Triangles, Trigonometry, Surface Areas & Volumes | TBD |
| **Exemplar Practice** | Question papers with solutions | TBD |
...
- [All Chapter PDFs](./resources/all/) - Combined textbook and exemplar content
- [Textbook Answers](./resources/all/textbook_answers.pdf) - Complete solutions
- [Exemplar Answers](./resources/all/exemplar_answers.pdf) - Exemplar problem solutions
- [Exemplar Question Papers](./resources/all/) - Practice papers (Set 1 & 2)
...
**Coming Soon:** Video tutorials on how to use these NotebookLM resources effectively for exam preparation.

### Suggested Prompts for NotebookLM
Use these prompts when interacting with the AI notebooks:

**Concept Clarity:**
- "Explain the Fundamental Theorem of Arithmetic with a real-life analogy"
- "What's the difference between AP and GP? Give examples"
- "Explain Pythagoras theorem proof step by step"

**Exam Preparation:**
- "List 5 important questions from this chapter that appear frequently in CBSE exams"
- "Create a 10-question practice test with increasing difficulty"
- "What are common mistakes students make in this chapter?"

**Quick Revision:**
- "Summarize all formulas in this chapter"
- "Create a mind map of key concepts"
- "List the most important theorems I need to memorize"

---

## 📊 Coverage Status

| Unit | Chapters | Notebook Status | Audio Generated |
| :--- | :--- | :---: | :---: |
| Algebra | 1-5 | ⏳ Pending | ⏳ Pending |
| Geometry | 6-7, 10-11 | ⏳ Pending | ⏳ Pending |
| Trigonometry | 8-9 | ⏳ Pending | ⏳ Pending |
| Mensuration & Statistics | 12-14 | ⏳ Pending | ⏳ Pending |
...
1. **Browse** the chapter table above to find your topic
2. **Click** the NotebookLM link to access the AI study guide
3. **Upload** the source PDFs to your own NotebookLM (if needed)
4. **Ask questions** using the suggested prompts
5. **Listen** to Audio Overviews while commuting or revising

---

## 📞 Feedback & Contributions

Found a broken link or have suggestions? Please open an issue or submit a pull request.

---

**Note:** All content is based on official NCERT textbooks and CBSE curriculum. These AI-powered notebooks are supplementary learning tools and should be used alongside traditional study methods.
