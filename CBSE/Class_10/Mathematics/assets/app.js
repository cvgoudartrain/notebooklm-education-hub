// ===================================
// CBSE Class 10 Mathematics - App.js
// Interactive Features & Progress Tracking
// ===================================

// Chapter Data Configuration
const chapterData = {
    '01': { difficulty: 'medium', category: 'algebra', time: 45, folder: '01_real_numbers', hasExemplar: true },
    '02': { difficulty: 'medium', category: 'algebra', time: 40, folder: '02_polynomials', hasExemplar: true },
    '03': { difficulty: 'easy', category: 'algebra', time: 35, folder: '03_linear_equations', hasExemplar: true },
    '04': { difficulty: 'hard', category: 'algebra', time: 50, folder: '04_quadratic_equations', hasExemplar: true },
    '05': { difficulty: 'medium', category: 'algebra', time: 45, folder: '05_arithmetic_progressions', hasExemplar: true },
    '06': { difficulty: 'hard', category: 'geometry', time: 60, folder: '06_triangles', hasExemplar: true },
    '07': { difficulty: 'medium', category: 'geometry', time: 40, folder: '07_coordinate_geometry', hasExemplar: true },
    '08': { difficulty: 'hard', category: 'trigonometry', time: 55, folder: '08_trigonometry', hasExemplar: true },
    '09': { difficulty: 'medium', category: 'trigonometry', time: 30, folder: '09_applications_trigonometry', hasExemplar: false },
    '10': { difficulty: 'medium', category: 'geometry', time: 40, folder: '10_circles', hasExemplar: true },
    '11': { difficulty: 'easy', category: 'geometry', time: 25, folder: '11_constructions', hasExemplar: true },
    '12': { difficulty: 'medium', category: 'mensuration', time: 45, folder: '12_areas_circles', hasExemplar: true },
    '13': { difficulty: 'hard', category: 'mensuration', time: 55, folder: '13_surface_areas_volumes', hasExemplar: true },
    '14': { difficulty: 'medium', category: 'mensuration', time: 50, folder: '14_statistics', hasExemplar: true }
};

// LocalStorage Keys
const STORAGE_KEYS = {
    THEME: 'cbse_maths_theme',
    PROGRESS: 'cbse_maths_progress',
    ACHIEVEMENTS: 'cbse_maths_achievements',
    LAST_VISIT: 'cbse_maths_last_visit',
    STREAK: 'cbse_maths_streak'
};
...
class ProgressManager {
    ...
    getProgressPercent() {
        return Math.round((this.getCompletedCount() / 14) * 100);
    }
    ...
    checkAchievements() {
        ...
        if (completed >= 7) this.unlockAchievement('half-course');
        if (completed >= 14) this.unlockAchievement('full-course');
