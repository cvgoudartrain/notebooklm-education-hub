// ===================================
// CBSE Class 11 Chemistry - App.js
...
// LocalStorage Keys
const STORAGE_KEYS = {
    THEME: 'cbse_class11_chemistry_theme',
    PROGRESS: 'cbse_class11_chemistry_progress',
    ACHIEVEMENTS: 'cbse_class11_chemistry_achievements',
    LAST_VISIT: 'cbse_class11_chemistry_last_visit',
    STREAK: 'cbse_class11_chemistry_streak'
};
...
class ProgressManager {
    ...
    getProgressPercent() {
        return Math.round((this.getCompletedCount() / 9) * 100);
    }
    ...
    checkAchievements() {
        ...
        if (completed >= 5 && !this.achievements.halfwayThere) {
            this.achievements.halfwayThere = true;
            newAchievement = true;
            this.showAchievement('Halfway There!', 'Completed 5 chapters');
        }

        if (completed === 9 && !this.achievements.allComplete) {
            this.achievements.allComplete = true;
            newAchievement = true;
            this.showAchievement('Course Complete!', 'Mastered all 9 chapters');
        }
