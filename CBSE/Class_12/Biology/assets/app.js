...
// LocalStorage Keys
const STORAGE_KEYS = {
    THEME: 'cbse_biology_theme',
    PROGRESS: 'cbse_biology_progress',
    ACHIEVEMENTS: 'cbse_biology_achievements',
    LAST_VISIT: 'cbse_biology_last_visit',
    STREAK: 'cbse_biology_streak'
};
...
class ProgressManager {
    ...
    checkAchievements() {
        ...
        if (completed >= 13) this.unlockAchievement('full-course');
