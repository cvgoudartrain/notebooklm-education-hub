// ===================================
// CBSE Class 12 Chemistry - App.js
...
// LocalStorage Keys
const STORAGE_KEYS = {
    THEME: 'cbse_class12_chemistry_theme',
    PROGRESS: 'cbse_class12_chemistry_progress',
    ACHIEVEMENTS: 'cbse_class12_chemistry_achievements',
    LAST_VISIT: 'cbse_class12_chemistry_last_visit',
    STREAK: 'cbse_class12_chemistry_streak'
};
...
class ProgressManager {
    ...
    checkAchievements() {
        ...
        if (completed === 10 && !this.achievements.allComplete) {
            this.achievements.allComplete = true;
            newAchievement = true;
            this.showAchievement('Course Complete! 🏆', 'Mastered all 10 chapters');
        }
