...
// LocalStorage Keys
const STORAGE_KEYS = {
    THEME: 'cbse_class12_physics_theme',
    PROGRESS: 'cbse_class12_physics_progress',
    ACHIEVEMENTS: 'cbse_class12_physics_achievements',
    LAST_VISIT: 'cbse_class12_physics_last_visit',
    STREAK: 'cbse_class12_physics_streak'
};
...
class ProgressManager {
    ...
    checkAchievements() {
        ...
        if (completed === 14 && !this.achievements.allComplete) {
            this.achievements.allComplete = true;
            newAchievement = true;
            this.showAchievement('Course Complete! 🏆', 'Mastered all 14 chapters');
        }
